...
def set_analysis_filter(run_info, entity_filter, time_from, time_to, use_environment_cache, forced_entity_id_main, forced_entity_id_target, forced_schema_id, forced_key_id):
