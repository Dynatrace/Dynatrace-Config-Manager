...
import (
	"bytes"
	"fmt"
	"github.com/Dynatrace/Dynatrace-Config-Manager/one-topology/internal/strings"
	template2 "github.com/Dynatrace/Dynatrace-Config-Manager/one-topology/internal/template"
